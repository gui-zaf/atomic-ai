...
const translations = {
  en: {
    ...
    noTokensPlaceholder: "No tokens available...",
    tokensExhausted: "Tokens Exhausted",
    tokensExhaustedMessage: "You've run out of free tokens. Wait for the recharge or buy more tokens.",
    tokensRefreshed: "Tokens Refreshed",
    tokensRefreshedMessage: "You received 3 additional tokens and cooldown has been reset!",
    notEnoughTokens: "Not enough tokens",
    notEnoughTokensMessage: "This operation requires {0} tokens, but you only have {1}.",
  ...
  pt: {
    ...
    noTokensPlaceholder: "Sem tokens disponíveis...",
    tokensExhausted: "Tokens Esgotados",
    tokensExhaustedMessage: "Seus tokens gratuitos acabaram. Aguarde a recarga ou adquira mais tokens.",
    tokensRefreshed: "Tokens Atualizados",
    tokensRefreshedMessage: "Você recebeu 3 tokens adicionais e o tempo de espera foi reiniciado!",
    notEnoughTokens: "Tokens Insuficientes",
    notEnoughTokensMessage: "Esta operação requer {0} tokens, mas você só tem {1}.",
