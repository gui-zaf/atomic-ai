...
const plans: TokenPlan[] = [
  {
    ...
    description: 'Perfect for casual users looking to explore AI capabilities with basic features.',
  },
  {
    id: 'pro',
    name: 'Quantum',
    ...
    description: 'Our most popular plan. Perfect balance of features and value for regular users.',
    color: '#0071E3',
  },
  {
    id: 'unlimited',
    ...
    description: 'For power users who need it all. Unlimited access to our most advanced AI features.',
  },
];
      ...
      >
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
          <View style={styles.header}>
            ...
            <Text style={[styles.title, { color: colors.text }]}>Token Store</Text>
                ...
                >
                  <TouchableOpacity
                    style={[
                      ...
                      plan.featured && [
                        styles.featuredCard,
                        { 
                          backgroundColor: isDarkMode ? colors.primaryBackground : colors.surface,
                  ...
                  >
                    ...
                    <Text style={[
                      styles.planName, 
                      { color: colors.text },
                      plan.featured && { color: plan.color || colors.primary, fontWeight: '700' }
                    ]}>
                      {plan.name}
                    </Text>
                    
                    <View style={styles.tokenContainer}>
                      <Ionicons name="flash" size={24} color={plan.featured ? plan.color || colors.primary : colors.primary} />
                    ...
                    <TouchableOpacity 
                      style={[
                        styles.selectButton,
                        { backgroundColor: plan.featured ? plan.color || colors.primary : colors.surface,
                          borderColor: plan.color || colors.primary }
                      ]}
                      onPress={() => handlePlanSelect(plan)}
                    >
                      <Text style={[
                        ...
                        { color: plan.featured ? 'white' : plan.color || colors.primary }
                      ]}>
                        Select Plan
                      </Text>
                    </TouchableOpacity>
                ...
                {selectedPlan && (
                  <>
                    ...
                    <View style={styles.modalTokenContainer}>
                      ...
                      <Text style={[styles.modalTokenCount, { color: colors.text }]}>
